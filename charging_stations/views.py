                ...
                for qr_session in qr_sessions:
                    try:
                        ...
                        session_data = {
                            ...
                            'payment_status': qr_session.payment_transaction.status if qr_session.payment_transaction else 'pending',
                            'payment_status_display': qr_session.payment_transaction.get_status_display() if qr_session.payment_transaction else 'Pending',
